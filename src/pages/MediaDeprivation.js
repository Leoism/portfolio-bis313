  ...
  render() {
    return (
      <div class="challenge-page">
        ...
        <button className="reveal-button" onClick={this.revealImage.bind(this, 'day0')}>Click to Reveal Image</button>
        {this.state.day0 ? <img className="challenge-image" src={introPicture} /> : null}
        ...
        <button className="reveal-button" onClick={this.revealImage.bind(this, 'day1')}>Click to Reveal Image</button>
        {this.state.day1 ? <img className="challenge-image" src={dashboardList} /> : null}
        ...
        <button className="reveal-button" onClick={this.revealImage.bind(this, 'day2')}>Click to Reveal Image</button>
        {this.state.day2 ? <img className="challenge-image" src={recapDay2} /> : null}
        ...
        <button className="reveal-button" onClick={this.revealImage.bind(this, 'day3')}>Click to Reveal Image</button>
        {this.state.day3 ? <img className="challenge-image" src={recapDay3} /> : null}
        ...
        <button className="reveal-button" onClick={this.revealImage.bind(this, 'day4')}>Click to Reveal Image</button>
        {this.state.day4 ? <img className="challenge-image" src={recapDay4} /> : null}
        ...
        <button className="reveal-button" onClick={this.revealImage.bind(this, 'day5')}>Click to Reveal Image</button>
        {this.state.day5 ? <img className="challenge-image horizontal" src={recapDay5} /> : null}
