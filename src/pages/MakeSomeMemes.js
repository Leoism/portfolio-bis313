  ...
  render() {
    return (
      <div className="challenge-page">
        ...
        <h2>Panik Meme</h2>
        <button className="reveal-button" onClick={this.revealImage.bind(this, 'panik')}>Click to Reveal Image</button>
        {this.state.panik ? <img alt="Meme using the Panik template" className="challenge-image" src={panikMeme} /> : null}
        ...
        <button className="reveal-button" onClick={this.revealImage.bind(this, 'grave')}>Click to Reveal Image</button>
        {this.state.grave ? <img alt="Meme using the Grave template" className="challenge-image" src={graveMeme} /> : null}
        ...
        <button className="reveal-button" onClick={this.revealImage.bind(this, 'boyfriend')}>Click to Reveal Image</button>
        {this.state.boyfriend ? <img alt="Meme using the Boyfriend template" className="challenge-image horizontal" src={boyfriendMeme} /> : null}
